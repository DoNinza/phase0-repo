...
사용법: python scripts/run_g0_backtest.py [--strategy vcb_gap|gap_rebound|gap_rebound_v|vbp|all]
...
def main() -> None:
    ...
    print(f"[{strategy_name}] {len(tickers)}종목({universe}), {start}~{end} 실데이터로 G0 백테스트 시작")
